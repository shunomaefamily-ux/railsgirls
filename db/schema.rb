...
ActiveRecord::Schema[8.1].define(version: 2026_03_12_104558) do
  ...
  create_table "medication_items", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "usage_kind"
    t.json "usage_slots", default: [], null: false
    t.string "usage_text"
    ...
    t.index ["usage_kind"], name: "index_medication_items_on_usage_kind"
  end
